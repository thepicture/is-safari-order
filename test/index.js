...
const isSafariOrder = require("../index");
...
it("should return true with node:http library headers", () => {
  ...
  const actual = isSafariOrder(headers);
...
it("should return false with non-safari order", () => {
...
it("should work with rawHeaders entries", () => {
  ...
  const actual = isSafariOrder(headers, { areRawHeaders: true });
